...
def default_settings(args):
    ...
    args.num_heads = 4
    args.cond_dim = 91
    args.features_dim = len(args.column_names)
    args.input_dim = args.cond_dim + args.features_dim
    args.noise_dim = 4
    args.cond_emb_wind_dim = 16
    args.cond_emb_hourly_dim = 36
    args.cond_emb_daily_dim = 16
    args.cond_emb_weekly_dim = 64
    args.cond_emb_dim = args.cond_emb_wind_dim + args.cond_emb_hourly_dim + args.cond_emb_daily_dim + args.cond_emb_weekly_dim
    args.noise_emb_dim = 17
    args.d_model = args.input_dim + args.cond_emb_dim + args.noise_emb_dim + args.features_dim
